...
<div class="w3-top">
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    ...
    <a href="Login_form.php" class="w3-bar-item w3-button" onclick="toggleFunction()">LOGIN</a>
...
<div class="w3-content w3-container w3-padding-64 " id="about">
  <h3 class="w3-center w3-text-teal">ABOUT OUR TEAM</h3>
  <p class="w3-center w3-text-teal"><em>We love code</em></p>
  <p></p>
  <br >
  <!-- COMBAK: parallax -->
  ...
  <div class="w3-row ">
    <div class="w3-col m6 w3-center w3-padding-large w3-text-red">
      <p class="mem" ><b><i class="fa fa-user w3-margin-right"></i>Nguyễn Danh Nam</b></p><br>
      <img src="image/28.png" class="w3-round w3-image  " alt="Photo of Me" width="500" height="333">
    </div>

    <!-- Hide this text on small devices -->
    <div class="w3-col m6 w3-hide-small w3-padding-large w3-text-black">
      <p>Trưởng nhóm.</p>
